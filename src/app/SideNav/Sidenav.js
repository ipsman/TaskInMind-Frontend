            ...
            <div className="flex flex-col h-full">
                ...
                <div className="absolute bottom-2 left-2 flex items-center space-x-4">
                    ...
                    <div className={`
                        ...
                        <button className={`hover:text-gray-400 transition-all duration-300 active:scale-75 ${isCollapsed ? 'mb-2 -translate-y-[70px] scale-125' : ''}`} onClick={openSettings}> {/* translateY megmarad */}
                        ...
                        <button className={`hover:text-gray-400 transition-all duration-300 active:scale-75 ${isCollapsed ? '-translate-y-[50px] scale-125' : ''}`} onClick={handleLogoutClick}> {/* translateY megmarad */}
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
