...
const TopNav = ({ currentMonth, goToPreviousMonth, goToNextMonth, goToToday, onSelectToday }) => {
  const months = [
  ...
  return (
    <div className="dark:bg-[#000000b9] bg-[#ffffffb9] px-[20px] h-[55px] flex justify-between">
      ...
      <div className='flex'>
        <button className='hover:text-gray-400 transition-all duration-300' onClick={onSelectToday}>
